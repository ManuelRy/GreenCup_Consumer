...
<div class="gallery-container">
    ...
    <div class="d-lg-none mb-3">
        <button class="btn btn-success w-100 d-flex align-items-center justify-content-center gap-2"
                data-bs-toggle="offcanvas" data-bs-target="#storesPanel" aria-controls="storesPanel">
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0"
                                       id="storeSearch" placeholder="Search stores...">
                            </div>
                        </div>
                    ...
                    <div class="p-3 border-bottom">
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0"
                                       id="mobileStoreSearch" placeholder="Search stores...">
                            </div>
                        </div>
...
.store-avatar.platinum { background: linear-gradient(135deg, #9B59B6, #8E44AD); }
.store-avatar.gold { background: linear-gradient(135deg, #FFD700, #FFA500); color: #333; }
.store-avatar.silver { background: linear-gradient(135deg, #C0C0C0, #A8A8A8); color: #333; }
.store-avatar.bronze { background: linear-gradient(135deg, #CD7F32, #B87333); }
.store-avatar.standard { background: linear-gradient(135deg, #198754, #20c997); }
...
function renderPosts() {
    const postsHTML = app.posts.map(post => `
        <div class="post-card position-relative" onclick="openPostModal(${post.id})">
            ...
            <img src="${post.photo_url}" alt="${post.caption}" class="post-image" onerror="this.src='data:image/svg+xml;base64,'">
            <div class="p-2">
                <small class="text-truncate d-block fw-medium">${post.caption || 'Store Post'}</small>
