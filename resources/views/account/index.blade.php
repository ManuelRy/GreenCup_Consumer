                ...
                <div class="col-auto">
                  <div class="d-flex justify-content-center gap-4">
                    <div class="text-center">
                      ...
                      <span class="fw-semibold text-dark">{{ number_format($total['earned'])}} pts</span>
                    </div>
                    <div class="text-center">
                      <small class="text-muted d-block mb-1">Total Spent</small>
                      <span class="fw-semibold text-dark">{{ number_format($total['spent']) }} pts</span>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="card border shop-wallet-card h-100 cursor-pointer">
                      <div class="card-body p-3">
                        <div class="d-flex align-items-center mb-3">
                          <div class="shop-logo-small bg-success text-white rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 45px; height: 45px;">
                        ...
                        <div class="text-center mb-3">
                          <div class="fw-bold text-primary mb-1" style="font-size: 1.5rem;">{{ number_format($wallet->coins )}}</div>
                        ...
                        <div class="row g-2 text-center">
                          <div class="col-4">
                            ...
                            <span class="fw-semibold text-dark small">{{ number_format($wallet->earned)  }}</span>
                          </div>
                          <div class="col-4">
          ...
          <div class="card-body p-0">
            <div class="p-4">
              ...
              <div class="list-group list-group-flush">
                <a href="{{ route('account.edit') }}" class="list-group-item list-group-item-action border-0 rounded-3 mb-2 py-3">
                  <div class="d-flex align-items-center">
                    <div class="setting-icon bg-gradient-primary text-white rounded-3 d-flex align-items-center justify-content-center me-3" style="width: 40px; height: 40px;">
                ...
                <div class="list-group-item list-group-item-action border-0 rounded-3 mb-2 py-3 cursor-pointer" onclick="showPasswordChangeModal()">
                  <div class="d-flex align-items-center">
                    <div class="setting-icon bg-gradient-primary text-white rounded-3 d-flex align-items-center justify-content-center me-3" style="width: 40px; height: 40px;">
                ...
                <a href="{{ route('account.transactions') }}" class="list-group-item list-group-item-action border-0 rounded-3 py-3">
                  <div class="d-flex align-items-center">
                    <div class="setting-icon bg-gradient-primary text-white rounded-3 d-flex align-items-center justify-content-center me-3" style="width: 40px; height: 40px;">
          ...
          <div class="card-body border-top p-0">
            <div class="p-4">
              <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('account.transactions') }}" class="btn btn-outline-primary btn-sm">
                  See All
                </a>
              </div>

              @forelse($transactions->take(5) as $transaction)
                <div class="card border transaction-card mb-3 cursor-pointer" onclick="showTransactionDetail({{ json_encode($transaction) }})">
                  <div class="card-body p-3">
