                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown">
                            <div class="user-avatar me-2">
                                {{ strtoupper(substr(auth('consumer')->user()->full_name ?? 'U', 0, 1)) }}
                            </div>
                            <span class="d-none d-lg-inline">{{ auth('consumer')->user()->full_name ?? 'User' }}</span>
                        </a>
        ...
        <div class="offcanvas-body">
            <div class="d-flex flex-column">
                <div class="text-center mb-4">
                    ...
                    <h6>{{ auth('consumer')->user()->full_name ?? 'User' }}</h6>
                    <small class="text-muted">{{ auth('consumer')->user()->email ?? '' }}</small>
                </div>
