...
@section('title', 'Gallery - Green Cup')
...
<div class="gallery-container">
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">Discover stores and their amazing posts</p>
    </div>
        ...
        <div class="gallery-controls">
            <div class="search-section">
                <div class="search-bar">
                    ...
                    <input type="text" id="gallery-search" placeholder="Search stores or posts..." class="search-input">
                </div>
